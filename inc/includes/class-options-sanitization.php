...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'tatva' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'tatva' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'tatva' ),
		'repeat'    => esc_html__( 'Repeat All', 'tatva' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'tatva' ),
		'top center'    => esc_html__( 'Top Center', 'tatva' ),
		'top right'     => esc_html__( 'Top Right', 'tatva' ),
		'center left'   => esc_html__( 'Middle Left', 'tatva' ),
		'center center' => esc_html__( 'Middle Center', 'tatva' ),
		'center right'  => esc_html__( 'Middle Right', 'tatva' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'tatva' ),
		'bottom center' => esc_html__( 'Bottom Center', 'tatva' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'tatva')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'tatva' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'tatva')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'tatva' ),
		'italic'      => esc_html__( 'Italic', 'tatva' ),
		'bold'        => esc_html__( 'Bold', 'tatva' ),
		'bold italic' => esc_html__( 'Bold Italic', 'tatva' )
		);
